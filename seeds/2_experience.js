    ...
    .then(function () {
      return Promise.all([
        ...
        knex('experience').insert({
          ...
          text2: "The new product pages integrate all available formats in a dropdown, provides sample clips from the product, and includes download instructions for downloadable formats. On the right of the product information, the mini cart was added, a new section focused on upselling the product with others was added, adn the recently view products were added.",
          text3: "A mobile version of the website was built during the revamp for a better user experience on tablets and smart phones. Some components of the full site were removed from the mobile site like the slideshow and blog feed because of the limited space on smaller device. If a user on a smaller device prefers the full site, they can switch to the full site using a link in the footer.",
          text4: "",
