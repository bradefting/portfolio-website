    ...
    .then(function () {
      return Promise.all([
        ...
        knex('experience').insert({
          ...
          text2: "The new product pages integrate the downloadable products with the other formats in a dropdown, provide sample clips from the products, and include download instructions for the downloadable formats. On the right of the product information, the mini cart was added, a new section offering the product as a set with another product was added, and the recently view products were added.",
