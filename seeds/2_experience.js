    ...
    .then(function () {
      return Promise.all([
        ...
        knex('experience').insert({
          ...
          text1: "Changes to the homepage include an easy to find reservation link in the header, images and brief descriptions of the most popular bungalows, navigation to added pages, and a larger slideshow.",
