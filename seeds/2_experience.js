    ...
    .then(function () {
      return Promise.all([
        ...
        knex('experience').insert({
          ...
          full_description: "Some of the major changes to Paladin Press' website were converting the website to HTML5, integrating the downloadable formats of products into the product pages, creating a mobile version of the website, and expediting the checkout process. The overall look of the website was also adjusted with the newsletter signup positioned in the header of each page and the mini cart and blog feed were added to the homepage. The changes to the website were beneficial with more newsletter signups, less cart abandonments, and increased sales of downloadable products.",
          ...
          text1: "The new homepage has the newsletter signup in the header, a box to advertise for sales and promotions below the left navigation, and a mini cart and blog feed in a column on the right. It was important to the owner of the company to showcase more products above the fold of the homepage so the size of the slideshow was decreased and three additional best-selling products were positioned above the fold.",
