    ...
    .then(function () {
      ...
      // Inserts seed entries
        knex('portfolio_projects').insert({
          ...
          technologies: 'Microsoft Bot Framework, Azure App Services, Node, Bootstrap',
        ...
        knex('portfolio_projects').insert({
          ...
          technologies: 'Materialize, jQuery, AJAX, Node, Express, Knex.js, PostgreSQL, Heroku',
        ...
        knex('portfolio_projects').insert({
          ...
          full_description: "GooseHire is a full-stack web app that uses AngularJS to create a single-page application. GooseHire was built with component-based Angular 1.6 to data-bind the model and view and ui-router is used for state based routing. A Node server is used with Mongoose to route the requests to a MongoDB database. Passport OAuth with LinkedIn is used to authenticate users at login. ",
          technologies: 'AngularJS, Pure.css, Node, MongoDB, Mongoose, Passport OAuth, Heroku',
