    ...
    .then(function () {
      ...
      // Inserts seed entries
        knex('portfolio_projects').insert({
          ...
          short_description: "Web app that uses a bot to pre-qualify users for a spinal cord injury rehab program. Uses Microsoft Bot Framework to accept user input on website and on Facebook Messenger.",
        ...
        knex('portfolio_projects').insert({
          ...
          short_description: "Full-stack web app that matches a user's skills with job descriptions using the Indeed API then a word cloud is created with the skills in the job description.",
          ...
          step1: "Enter the skills and technologies that you would like to search using Indeed. Add the city or 5-digit zip code of your prefered job location.",
        ...
        knex('portfolio_projects').insert({
          ...
          step3: "Want beer recommendations based on an event? Select an event from a drop down menu and Brewzinga! will make an appropriate recommendation.",
